...
public final class BindingTools {
	 ...
	 */
	public static PropertyBindingLink createBinding(Object source,
			String sourceProperty, Object target, String targetProperty) {
		return new PropertyBindingLink(new BeanBindingSource(source,
				sourceProperty), new BeanBindingTarget(target, targetProperty));
	}
	 ...
	 *            : source bean
	 * @param getMethodName
	 *            : method to get the map value (see {@link MapBindingSource}
	 *            constructor)
	 * @param mapPrpertyKey
	 *            : property key to listen to / to use in map getter (see
	 ...
	 */
	public static PropertyBindingLink createBinding(Object source,
			String getMethodName, String mapPrpertyKey, Object target,
	 ...
	 * @return - the binding link
	 */
	public static <T> ListBindingLink<T> createBinding(
			ObservableList<T> source, List<T> target) {
		return new ListBindingLink<T>(new BasicListBindingSource<T>(source),
				new BasicListBindingTarget<T>(target));
	}
	 ...
	 * 
	 * @param <T>
	 *            : source list element type
	 * @param source
	 *            : binding source list
	 * @param bindingTarget
	 *            : binding target (null available)
	 * @return - the binding link
	 */
	public static <T> ListBindingLink<T> createBinding(
			ObservableList<T> source, ListBindingTarget<T> bindingTarget) {
		return new ListBindingLink<T>(new BasicListBindingSource<T>(source),
				bindingTarget);
	}
