...
public class IntrospectionTools {
     ...
     * 
     * @param bean : bean to search in
     * @param property : property name
     * @return - the bean property found
     * @throws IllegalArgumentException if the property does not exist in the bean
     * @throws RuntimeException if the introspection process failed
     */
    ...
    /**
     * Retrieves a method within an object
     * 
     * @param object : object searched (not null)
     * @param methodName - method name
     * @param parameters - method parameters
     * @return - the method found
     * @throws RuntimeException if a security problem happened (see
     *             {@link Class#getMethod(String, Class...)})
     * @throws IllegalArgumentException if the method is undefined
     */
    public static Method retrieveMethod(Object object, String methodName,
                                        Class<?>... parameters) {
        try {
            return object.getClass().getMethod(methodName, parameters);
        }
