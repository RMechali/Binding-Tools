...
import binding.list.definition.implementation.MutableArrayList;
...
public class TestListBinding {
    ...
    public void testDefaultBindings() {
        MutableList<Integer> source = new MutableArrayList<Integer>();
        source.add(2);
        source.add(4);
        source.add(6);
        source.add(8);
    ...
    public void testChangeSource() {
        MutableList<Integer> source1 = new MutableArrayList<Integer>();
        source1.add(2);
        source1.add(4);
        source1.add(6);

        MutableList<Integer> source2 = new MutableArrayList<Integer>();
        source2.add(1);
        source2.add(3);
        source2.add(5);
